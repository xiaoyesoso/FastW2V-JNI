        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String modelPath = copyAssetToInternalStorage("model.onnx");
                    String vocabPath = copyAssetToInternalStorage("vocab.txt");
                    String qaPath = copyAssetToInternalStorage("qa_list.csv");

                    // 2. 初始化引擎
                    enginePtr = W2VNative.initBertEngine(modelPath, vocabPath);
                    if (enginePtr == 0) {
